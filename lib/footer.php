<footer>
    ...
    <a href="http://<?php echo settingsdb(location); ?>" title="Главная">Главная</a> | <?php if(!settingsdb(bookmarklet) == 0):?><a href="http://wm-scripts.ru">wm-scripts.ru</a> |<?php endif; if(!settingsdb(api) == 0): ?><a href="http://uto.wm-scripts.ru"> Сервис коротких ссылок</a> | <?php endif; ?> Copyright &copy; <?=date("Y")?> - <?php echo settingsdb(name); ?></div>
