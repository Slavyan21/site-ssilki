...
?>
	<a href="http://<?php echo $config_location; ?>" title="Сервис сокращения ссылок" ><div id="logo"><?php echo settingsdb(name); ?></div></a> 
...
else
{
    ...
    print $buffer;
    echo ". <br/>Мы не можем сократить данный Url.</h2>";
}


	}else {
	    echo "<h2>Введен неправильный URL адресс, попробуйте снова.</h2>";
	}
?>
	</div>
